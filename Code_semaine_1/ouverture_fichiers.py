...
mca = MCA(r"semaine_2\W-Al(10)_20kV_25uA_2e_align.mca")
...
########## ENERGIE MAX #############
THRESHOLD = 1000  # Adjust based on noise level
...
###### PLOT ########     
plt.bar(energies, count_rate, width=np.median(np.diff(energies)), color="blue", alpha=0.5, label="Spectre avec filtre de Al (10- mils) + W (1 mils)")
